import 'package:oknoapp/data/saved_video.dart';
import 'package:stacked/stacked.dart';

class MySavedVideosProvider extends BaseViewModel {
  MySavedVideosAPI? videoSource;
  late int prevVideo;

  late int currentscreen;
  MySavedVideosProvider() {
    videoSource = MySavedVideosAPI();
  }
