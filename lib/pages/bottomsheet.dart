                              ...
                              child: FadeInAnimation(
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                        'Price - ₹${likedVideo ? feedViewModel2.videoSource!.listData[index].price : feedViewModel.videoSource!.listVideos[index].price}')
                                  ],
                                ),
                              ),
                            ),
